...
$title_custom_color = get_sub_field('title_custom_color');
$title_font_size_ld = get_sub_field('title_font_size_ld');
$title_font_size_mt = get_sub_field('title_font_size_mt');
$title_margin_bottom_ld = get_sub_field('title_margin_bottom_ld');
$title_margin_bottom_mt = get_sub_field('title_margin_bottom_mt');
